    ...
    var kity = require("kity"),
        ...
        RenderComponenet = kity.createClass('RenderComponent', {
            ...
            resize: function () {
                ...
                var widthDiff = (width - viewBox.width) / 2;
                var heightDiff = (height - viewBox.height) / 2;

                this.formula.setViewBox(viewBox.x - widthDiff, viewBox.y - heightDiff, width, height);
            },
            ...
            initServices: function () {
                ...
                this.kfEditor.registerService("render.resize", this, {
                    resize: this.resize
                });
